...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/js/bootstrap-select.min.js"></script>
 ...
 <body>
   ...
   <form action="tomadedatos.php" method="post" id="formulario">
     <br>
     <div class="input-group mb-3">
       <span class="input-group-text" id="basic-addon1">Ingrese el/los talle/s: </span>
       <select class="selectpicker" multiple data-live-search="true" name="talle[]" required>
       <option>M</option>
       <option>S</option>
       <option>XL</option>
       <option>XS</option>
     ...
     <div class="input-group mb-3" >
       <span class="input-group-text" id="basic-addon1">Seleccione su ciudad:</span>
       <select class="select" name="ciudad" required>
       <option value=""></option>
       <option value="san_nicolas">San Nicolas </option>
       <option value="ramallo">Ramallo</option>
       <option value="villa_constitucion">Villa Constitucion</option>
       </select>

     </div>
     <br> <br>
     <div class="input-group mb-3" id="input_formulario">
       <span class="input-group-text" id="basic-addon1">Ingrese su calle:</span>
       <input type="text" name="direccion" id="direccion" class="form-control" placeholder="direccion" aria-label="Username" aria-describedby="basic-addon1" required>
     </div>
     <br>
     <br>
     <div class="input-group mb-3" id="telefono_numero">
       <span class="input-group-text" id="basic-addon1">Ingrese su telefono:</span>
       <input type="text" name="telefono" id="telefono" class="form-control" placeholder="telefono" aria-label="Username" aria-describedby="basic-addon1" required>
     </div>
     <br>
